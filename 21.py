import numpy as np
import pandas as pd
data = pd.read_csv("C:/Users/welcome/Downloads/rare_element.csv")
con_measure = data["concentration"].values
...
sample_mean = np.mean(con_measure[:sample_size])
sample_std = np.std(con_measure[:sample_size], ddof=1)
