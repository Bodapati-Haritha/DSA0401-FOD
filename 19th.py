...
print("95% Confidence Interval for Mean Reduction in BP(New Drug):", confidence_interval_new_drug)
print("95% Confidence Interval for Mean Reduction in BP(Placebo):", confidence_interval_placebo)
